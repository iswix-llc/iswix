...
namespace ISWIXLLC.IsWiX2019AddIn
{
    ...
    [Guid(GuidList.guidIsWiX2019AddInPkgString)]
    public sealed class IsWiX2019AddInPackage : Package
    {
        /// <summary>
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidIsWiX2019AddInCmdSet, (int)PkgCmdIDList.cmdidLaunchIsWiX);
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                Microsoft.VisualStudio.ErrorHandler.ThrowOnFailure(uiShell.ShowMessageBox(
                           ...
                           ref clsid,
                           "IsWiX",
                           string.Format(CultureInfo.CurrentCulture, "IsWiX Failed to launch. Reason:\r\n{0}", ex.Message),
                           string.Empty,
                           0,
