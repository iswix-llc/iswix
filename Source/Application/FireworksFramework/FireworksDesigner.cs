...
namespace FireworksFramework
{
    ...
    public class FireworksDesigner : IFireworksDesigner
    {
        ...
        public IDesignerManager DesignerManager
        {
            set
            {
                // FireworksFramework does not implement the DesignerManager accessor as it is not really a Fireworks designer.
            }
        }
        ...
        public string PluginInformation
        {
            ...
            {
                // The fireworks framework is best always displayed second.
                return new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FireworksFramework.MS-PL.txt")).ReadToEnd();
